...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | FlexAPI - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for FlexAPI - React.js Tailwind CSS Admin Dashboard Template"
      />
