...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | FlexAPI - React.js Admin Dashboard Template"
        description="This is React.js Videos page for FlexAPI - React.js Tailwind CSS Admin Dashboard Template"
      />
